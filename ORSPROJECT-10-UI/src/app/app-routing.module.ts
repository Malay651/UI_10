...
import { LibrarysystemComponent } from './librarysystem/librarysystem.component';
import { LibrarysystemlistComponent } from './librarysystem/librarysystemlist.component';
import { SecurityalertComponent } from './securityalert/securityalert.component';
import { SecurityalertlistComponent } from './securityalert/securityalertlist.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    component: AllowlistListComponent
      ...
      {
    path: 'librarysystem',
    component: LibrarysystemComponent
     
  },
  {
    path: 'librarysystem/:id',
    component: LibrarysystemComponent
  },
  {
    path: 'librarysystemlist',
    component: LibrarysystemlistComponent
  },
        {
    path: 'securityalert',
  ...
  {
    path: 'securityalert/:id',
    component: SecurityalertComponent
  },
  {
    path: 'securityalertlist',
    component: SecurityalertlistComponent
  },
